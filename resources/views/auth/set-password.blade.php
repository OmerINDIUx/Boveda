...
<head>
    ...
    <title>Bóveda - Configurar Contraseña</title>
...
<body>
    ...
    <div class="login-container">
        <div class="logo-section">
            ...
            <p class="subtitle">Establece tu contraseña para acceder a Bóveda</p>
        </div>
        ...
        <div class="glass-card">
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <button type="submit" class="btn-primary">Establecer Contraseña</button>
            </form>
        </div>

        <div class="footer-text">
            &copy; {{ date('Y') }} Bóveda Control Documental.
        </div>
    </div>
</body>
</html>
